 ...
 */
public class BossAI extends Entity {
    ...
    void creatOrient(Player player) {

        if (countchangeorient % 3 == 0) {
            if (x < player.x) changeOrient(RIGHT);
            else if (x > player.x) changeOrient(LEFT);
            else if (x == player.x) {
